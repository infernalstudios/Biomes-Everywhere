...
public class BEWTreePlacers {
    ...
    public static final RegistryObject<FoliagePlacerType<GiantFoliagePlacer>> GIANT_FOLIAGE_PLACER = FOLIAGE_PLACERS.register("giant_foliage_placer", () -> new FoliagePlacerType<>(GiantFoliagePlacer.CODEC));
